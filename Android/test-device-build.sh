...
"$JDK/bin/java" -jar "$BT/lib/apksigner.jar" sign --ks signing/release.jks --ks-pass "pass:$STOREPASS" --key-pass "pass:$STOREPASS" --out build/device-tests/tests.apk build/device-tests/aligned.apk
